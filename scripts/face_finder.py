...
class FaceFinder:
    ...
    def __init__(self, image_stream, haar, pickled, preview_stream, resize=500):
        ...
        self._subscriber = rospy.Subscriber(image_stream, CompressedImage, self.callback,  queue_size = 1)
        self._publisher = rospy.Publisher(preview_stream, CompressedImage, queue_size = 1)
    ...
    def set_preview(self, preview) :
        if self._VERBOSE:
            rospy.loginfo(f"face_finder: got a message {preview}")
...
if __name__ == '__main__':
    ...
    haar = rospy.get_param('~haar', '/home/ros/catkin_ws/src/avatar/haarcascade_frontalface_default.xml')
    pickled = rospy.get_param('~pickle', '/home/ros/catkin_ws/src/avatar/faces.pickle')
